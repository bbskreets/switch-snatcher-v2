...
REFRESH_PERIOD = 0.5  # How often to refresh websites (seconds) | Type: float
...
HEADLESS = True  # If you start getting 'Unable to locate element' errors, change headless to False
